...
MODIFIED to add ieee_float from:
    https://github.com/python/cpython/blob/3.13/Lib/wave.py

    search for 'pyspectrum' for changes to original
...
WAVE_FORMAT_IEEE_FLOAT = 0x0003  # pyspectrum added
...
class Wave_read:
    ...
    def _read_fmt_chunk(self, chunk):
        try:
            # pyspectrum modified to have self._wFormatTag
        ...
        # pyspectrum modified to add WAVE_FORMAT_IEEE_FLOAT
        if self._wFormatTag != WAVE_FORMAT_PCM and self._wFormatTag != WAVE_FORMAT_IEEE_FLOAT and \
                self._wFormatTag != WAVE_FORMAT_EXTENSIBLE:
            raise Error('unknown format: %r' % (self._wFormatTag,))
        try:
...
class Wave_write:
    ...
    def initfp(self, file):
        ...
        self._wFormatTag = 0  # pyspectrum added
    ...
    def _ensure_header_written(self, datasize):
        if not self._headerwritten:
            ...
            # pyspectrum added
            if not self._wFormatTag:
                raise Error('data format not specified')
    ...
    def _write_header(self, initlength):
        ...
        # pyspectrum modified to add self._wFormatTag
